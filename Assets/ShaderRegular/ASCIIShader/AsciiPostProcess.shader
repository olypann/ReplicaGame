    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings i) : SV_Target
            {
                ...
                float wave =
                    sin(uv.x * 6.2831 * 2.0 + _Time.y * _WaveSpeed) *
                    0.5 +
                    sin(uv.y * 6.2831 * 1.5 + _Time.y * _WaveSpeed * 1.2) *
                    0.5;
                ...
                float3 randomColorOffset = (float3(
                ...
                if (_UseGradient > 0.5)
                {
                    ...
                    color = SAMPLE_TEXTURE2D(_GradientTex, sampler_GradientTex, float2(gradientPos, 0.5)).rgb;
                }
